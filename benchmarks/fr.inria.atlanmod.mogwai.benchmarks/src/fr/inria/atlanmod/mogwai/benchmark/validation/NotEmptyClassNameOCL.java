...
public class NotEmptyClassNameOCL extends OclQueryTest {
	
	private EClass context;
	
	public NotEmptyClassNameOCL(String resourceName) {
		super(resourceName);
	}
    ...
    public void setUp() throws Exception {
        ...
        try {
            expression = oclHelper.createQuery("not(self.name.oclIsUndefined()) and self.name <> ''");
