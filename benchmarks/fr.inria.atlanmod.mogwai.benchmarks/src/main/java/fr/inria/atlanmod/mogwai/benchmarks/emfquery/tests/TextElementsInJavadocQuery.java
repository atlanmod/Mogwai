...
public class TextElementsInJavadocQuery extends EMFQueryTest {

	public TextElementsInJavadocQuery(String resourceName) {
		super(resourceName);
	}
	...
	public void test() {
		...
		EObjectCondition condition = 
				new EObjectTypeRelationCondition(JavaPackage.eINSTANCE.getJavadoc());
