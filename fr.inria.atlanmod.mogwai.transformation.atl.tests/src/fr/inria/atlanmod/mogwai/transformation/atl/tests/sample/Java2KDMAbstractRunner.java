...
public class Java2KDMAbstractRunner {
	...
	public Java2KDMAbstractRunner() {
		try {
			...
			InputStream java2kdmStream = getFileURL("abstractTypeDeclaration2kdmEntity.asm").openStream();
...
//				System.out.println(os.toString());
	...
	protected static URL getFileURL(String fileName) throws IOException {
		URL fileURL;
		if(isEclipseRunning()) {
			URL resourceURL = Java2KDMAbstractRunner.class.getResource(fileName);
			if(resourceURL != null) {
			...
			fileURL = Java2KDMAbstractRunner.class.getResource(fileName);
		}
		if(fileURL == null) {
