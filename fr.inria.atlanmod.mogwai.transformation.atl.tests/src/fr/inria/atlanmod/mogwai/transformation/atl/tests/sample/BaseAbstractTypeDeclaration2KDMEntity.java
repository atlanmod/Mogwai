...
public class BaseAbstractTypeDeclaration2KDMEntity {
	...
	public static void main(String[] args) throws IOException {
		...
		Java2KDMAbstractRunner runner = new Java2KDMAbstractRunner();
...
//				.arraysMappedBuffer("49M")
		...
		Resource neoOutput = rSet.createResource(BlueprintsURI.createFileURI(new File("materials/kdm/sample/neoemf/"+THE_SET+".graphdb")));
