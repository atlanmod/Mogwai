...
public class BaseConcreteTypeDeclaration2KDMEntity {
	...
	public static void main(String[] args) throws IOException {
		...
		Java2KDMConcreteRunner runner = new Java2KDMConcreteRunner();
...
//				.autocommit()
		...
		Resource neoOutput = rSet.createResource(BlueprintsURI.createFileURI(new File("materials/kdm/sample/concrete/neoemf/"+THE_SET+".graphdb")));
