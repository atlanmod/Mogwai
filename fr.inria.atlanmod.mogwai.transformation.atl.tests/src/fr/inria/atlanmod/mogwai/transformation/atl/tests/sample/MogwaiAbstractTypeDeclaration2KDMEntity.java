...
import fr.inria.atlanmod.mogwai.transformation.atl.tests.sample.BaseAbstractTypeDeclaration2KDMEntity.MemoryChecker;
...
public class MogwaiAbstractTypeDeclaration2KDMEntity {
	...
	public static int MEMORY_CHECK_INTERVAL = 100;
