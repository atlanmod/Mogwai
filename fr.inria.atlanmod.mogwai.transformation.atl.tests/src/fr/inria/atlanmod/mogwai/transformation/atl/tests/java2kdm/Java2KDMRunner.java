...
public class Java2KDMRunner {
	...
	public Java2KDMRunner() {
		try {
			...
			InputStream java2kdmStream = getFileURL("java2kdm_simple.asm").openStream();
	...
	protected static URL getFileURL(String fileName) throws IOException {
		URL fileURL;
		if(isEclipseRunning()) {
			URL resourceURL = Java2KDMRunner.class.getResource(fileName);
			if(resourceURL != null) {
			...
			fileURL = Java2KDMRunner.class.getResource(fileName);
		}
		if(fileURL == null) {
