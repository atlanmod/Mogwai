...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>In EPipe</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.inria.atlanmod.mogwai.gremlin.impl.InEPipeImpl#getRelationshipName <em>Relationship Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InEPipeImpl extends PipeImpl implements InEPipe {
	/**
	...
	protected EClass eStaticClass() {
		return GremlinPackage.Literals.IN_EPIPE;
	}
	...
	public void setRelationshipName(String newRelationshipName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GremlinPackage.IN_EPIPE__RELATIONSHIP_NAME, oldRelationshipName, relationshipName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GremlinPackage.IN_EPIPE__RELATIONSHIP_NAME:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case GremlinPackage.IN_EPIPE___TO_STRING:
				return toString();
		}
