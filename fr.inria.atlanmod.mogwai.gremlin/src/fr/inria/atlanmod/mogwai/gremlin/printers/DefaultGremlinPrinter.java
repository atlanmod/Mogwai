...
public class DefaultGremlinPrinter extends GremlinSwitch<String> {
	...
	public String caseIndexCall(IndexCall o) {
		StringBuffer res = new StringBuffer();
		res.append("getIndex(\""+o.getIndexName()+"\",Vertex.class)[["+o.getIndexProperty()+":\""+o.getIndexQuery()+"\"]]");
		if(o.getNextElement() != null) {
			res.append(".").append(doSwitch(o.getNextElement()));
		}
		return res.toString();
	...
	public String caseTernaryOperator(TernaryOperator o) {
		StringBuffer res = new StringBuffer();
		res.append("(");
		res.append(doSwitch(o.getCondition()))
		.append(" ? ").append(doSwitch(o.getIfTrue())).append(" : ").
