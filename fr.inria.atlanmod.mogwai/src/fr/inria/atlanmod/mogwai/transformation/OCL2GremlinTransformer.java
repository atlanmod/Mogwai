...
public class OCL2GremlinTransformer {

	public EObject transform(EPackage packageInOcl, Constraint exp) {
		try {
			
			// Remove Warning during metamodel loading phase
			...
			// Reactivate Warning for the transformation itself
			ATLLogger.getLogger().setLevel(Level.ALL); 
			transformationLauncher.launch(ILauncher.RUN_MODE, new NullProgressMonitor(), new HashMap<String, Object>(), this.getClass().getResourceAsStream("ocl2gremlin.asm"));
